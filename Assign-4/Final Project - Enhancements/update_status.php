					...
					<form name='f1' method='POST' action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>'>
						<table>
							<tr>
								...
								<td> <textarea rols='20' cols='45' maxlength='300' name='status'> </textarea> </td>
								<td> (MAX 300 Characters) </td>
							</tr>
							<tr>
								<td colspan='2'> <input type='button' value='Update' onclick='sec()'> </td>
